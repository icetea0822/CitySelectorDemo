...
public class MainActivity extends AppCompatActivity implements OnItemClickListener {
    ...
    RecyclerView rvProvinve, rvCity, rvDistrict;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvProvinve = (RecyclerView) findViewById(R.id.rvProvince);
    ...
    private void initListView() {
        ...
        rvProvinve.setLayoutManager(new LinearLayoutManager(this));
        rvProvinve.addItemDecoration(new DividerItemDecoration(this, DividerItemDecoration.VERTICAL));
        rvProvinve.setAdapter(provinceAdapter);
    ...
    public void initData() {
        ...
        try {
            ...
            Gson gson = new Gson();
            cityEntity = gson.fromJson(stringBuffer.toString(), CityEntity.class);
